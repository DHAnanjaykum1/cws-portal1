        ...
        <div class="w-5/6  px-5">
            ...
            <table class="border-separate w-full border border-black mt-3">
                  ...
                  <tr>
                    ...
                    <a href="" class="bg-teal-700 px-2 py-0.5 text-xs rounded-xl hover:bg-teal-900"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
